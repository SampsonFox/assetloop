...
CREATE TABLE market_prices (
 tenant_id TEXT NOT NULL REFERENCES tenants(id), market_item_id TEXT NOT NULL,
...
CREATE TABLE asset_market_bindings (
 tenant_id TEXT NOT NULL REFERENCES tenants(id), asset_id TEXT NOT NULL, market_item_id TEXT NOT NULL,
