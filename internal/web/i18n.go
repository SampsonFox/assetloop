...
var messages = map[application.Locale]map[string]string{
	application.LocaleZhCN: {
		...
		"asset.fx_required": "仅非本位币必填", "asset.fx_confirm": "我确认使用上述汇率换算为", "asset.append": "追加记录", "asset.model_image_caption": "型号示意图；具体颜色以物品记录为准。", "asset.model_3d_label": "三维模型，可拖动旋转并滚动缩放", "asset.model_3d_loading": "正在载入 3D 模型…", "asset.model_3d_hint": "拖动旋转 · 滚轮或双指缩放", "asset.model_3d_reset": "重置视角",
	...
	application.LocaleEn: {
		...
		"asset.fx_required": "Required for foreign currency", "asset.fx_confirm": "I confirm conversion using this rate to", "asset.append": "Add record", "asset.model_image_caption": "Model reference image; the asset record is authoritative for color.", "asset.model_3d_label": "3D model; drag to rotate and scroll to zoom", "asset.model_3d_loading": "Loading 3D model…", "asset.model_3d_hint": "Drag to rotate · scroll or pinch to zoom", "asset.model_3d_reset": "Reset view",
