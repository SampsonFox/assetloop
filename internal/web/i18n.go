...
var messages = map[application.Locale]map[string]string{
	application.LocaleZhCN: {
		...
		"menu.label": "用户菜单", "menu.pending_imports": "待确认导入", "menu.catalog": "物品类型管理", "menu.members": "成员管理",
		...
		"common.back": "返回", "common.back_assets": "返回物品列表", "common.notes": "备注", "common.none": "暂无", "common.actions": "操作",
		"title.assets": "我的物品", "title.overview": "概览", "title.catalog": "物品类型配置", "title.imports": "待确认导入",
		...
		"assets.cards_label": "物品卡片", "assets.serial_number": "序列号", "assets.serial_missing": "尚未记录序列号", "assets.edit": "编辑物品",
		...
		"members.add": "新增成员", "members.initial_password": "初始密码", "members.create": "创建成员",
		...
		"asset.voided": "已作废", "asset.correct": "更正", "asset.no_events": "尚无生命周期记录。", "asset.add_event": "新增生命周期记录",
		"asset.event_type": "事件类型", "asset.occurred_at": "发生时间", "asset.amount_positive": "金额（正数）", "asset.original_currency": "原始货币",
		"asset.source": "交易来源", "asset.reference": "订单/凭证号", "asset.fx_rate": "汇率（1 原币 = 本位币）", "asset.fx_date": "汇率日期", "asset.fx_source": "汇率来源",
		"asset.fx_required": "仅非本位币必填", "asset.fx_confirm": "我确认使用上述汇率换算为", "asset.append": "追加记录",
		"event.purchase": "买入", "event.repair": "维修", "event.sale": "卖出", "event.void": "作废",
		"status.active": "持有中", "status.sold": "已卖出", "status.unacquired": "未入账",
		...
		"imports.eyebrow": "AI Harness 边界", "imports.base_currency": "本位币", "imports.locked": "已锁定", "imports.pending": "待确认记录",
		"imports.pending_help": "待确认记录是 AI 或人工识别产生的草稿；确认前不会计入物品生命周期。", "imports.recognized_amount": "识别金额", "imports.source": "来源", "imports.review": "复核确认", "imports.view_only": "仅查看",
		"imports.empty_heading": "暂无待确认记录", "imports.empty_help": "新的识别草稿会显示在这里，你可以逐条复核后再正式入账。", "imports.create_draft": "新建导入草稿", "imports.manual_entry": "手工录入",
		"imports.create_help": "此入口用于手工验证导入流程；保存后只生成待确认草稿，不会直接写入生命周期。", "imports.asset": "物品",
		"imports.recognized_currency": "识别货币", "imports.data_source": "数据来源", "imports.raw_text": "识别原文", "imports.save_pending": "保存为待确认",
		"confirm.eyebrow": "人工复核", "confirm.heading": "确认导入记录", "confirm.recognized": "识别内容", "confirm.original_amount": "原始金额", "confirm.reference": "凭证号",
		"confirm.rules": "落库规则", "confirm.base_rule": "系统统计统一使用本位币。", "confirm.same_currency": "本次与本位币一致，原币与汇率字段将保持为空。",
		"confirm.foreign_currency": "本次为非本位币，必须确认汇率、日期和来源，同时保留全部原始证据。", "confirm.fx_confirm": "我确认按上述日期和汇率换算后落库", "confirm.submit": "确认并写入生命周期",
		"error.eyebrow": "请求未完成", "error.internal": "系统暂时无法完成请求，请稍后重试。", "error.not_found_asset": "物品不存在", "error.not_found_event": "可更正记录不存在", "error.not_found_import": "待确认记录不存在",
		"error.forbidden_catalog": "当前角色不能维护物品类型配置", "error.forbidden_lifecycle": "当前角色不能修改生命周期记录", "error.forbidden_correct": "当前角色不能更正生命周期记录",
		"error.forbidden_import_create": "当前角色不能创建导入记录", "error.forbidden_import_confirm": "当前角色不能确认导入记录", "error.forbidden_asset": "当前角色不能修改具体物品", "error.forbidden_members": "只有 Owner 可以管理成员",
		...
		"validation.occurred_required": "发生时间不能为空。", "validation.occurred_future": "发生时间不能晚于当前时间。", "validation.event_type": "事件类型必须是买入、维修或卖出。", "validation.input_invalid": "输入内容无效，请检查后重试。",
		"validation.category_icon": "不支持该类别图标。", "validation.id_invalid": "记录标识无效。", "validation.field_required": "必填字段不能为空。", "validation.field_too_long": "输入内容超过长度限制。",
		"preferences.updated": "界面偏好已保存。",
	},
	application.LocaleEn: {
		"app.name": "AssetLoop", "nav.main": "Primary navigation", "nav.assets": "Assets",
		"menu.label": "User menu", "menu.pending_imports": "Pending imports", "menu.catalog": "Asset type settings", "menu.members": "Members",
		...
		"common.back": "Back", "common.back_assets": "Back to assets", "common.notes": "Notes", "common.none": "None", "common.actions": "Actions",
		"title.assets": "My assets", "title.overview": "Overview", "title.catalog": "Asset type settings", "title.imports": "Pending imports",
		...
		"assets.cards_label": "Asset cards", "assets.serial_number": "Serial number", "assets.serial_missing": "No serial number", "assets.edit": "Edit asset",
		...
		"members.add": "Add member", "members.initial_password": "Initial password", "members.create": "Create member",
		...
		"asset.voided": "Voided", "asset.correct": "Correct", "asset.no_events": "No lifecycle records yet.", "asset.add_event": "Add lifecycle record",
		"asset.event_type": "Event type", "asset.occurred_at": "Occurred at", "asset.amount_positive": "Amount (positive)", "asset.original_currency": "Original currency",
		...
		"asset.fx_required": "Required for foreign currency", "asset.fx_confirm": "I confirm conversion using this rate to", "asset.append": "Add record",
		"event.purchase": "Purchase", "event.repair": "Repair", "event.sale": "Sale", "event.void": "Void",
		"status.active": "Active", "status.sold": "Sold", "status.unacquired": "Not acquired",
		...
		"imports.eyebrow": "AI Harness boundary", "imports.base_currency": "Base currency", "imports.locked": "Locked", "imports.pending": "Pending records",
		"imports.pending_help": "Pending records are drafts produced by AI or manual recognition; they do not enter an asset lifecycle until confirmed.", "imports.recognized_amount": "Recognized amount", "imports.source": "Source", "imports.review": "Review and confirm", "imports.view_only": "View only",
		"imports.empty_heading": "No pending records", "imports.empty_help": "New recognition drafts appear here so you can review and post them one by one.", "imports.create_draft": "New import draft", "imports.manual_entry": "Manual entry",
		"imports.create_help": "Use this entry point to verify the import flow manually. Saving creates a pending draft and does not write directly to the lifecycle.", "imports.asset": "Asset",
		"imports.recognized_currency": "Recognized currency", "imports.data_source": "Data source", "imports.raw_text": "Recognized text", "imports.save_pending": "Save as pending",
		"confirm.eyebrow": "Manual review", "confirm.heading": "Confirm import", "confirm.recognized": "Recognized content", "confirm.original_amount": "Original amount", "confirm.reference": "Reference",
		"confirm.rules": "Storage rules", "confirm.base_rule": "All system statistics use the base currency. ", "confirm.same_currency": "This record already uses the base currency; original-currency and FX fields remain empty.",
		"confirm.foreign_currency": "This is a foreign-currency record. Confirm the rate, date, and source while preserving all original evidence.", "confirm.fx_confirm": "I confirm conversion using the rate and date above", "confirm.submit": "Confirm and add to lifecycle",
		"error.eyebrow": "Request not completed", "error.internal": "The system could not complete the request. Please try again.", "error.not_found_asset": "Asset not found", "error.not_found_event": "Correctable record not found", "error.not_found_import": "Pending import not found",
		...
		"error.forbidden_import_create": "Your role cannot create import records", "error.forbidden_import_confirm": "Your role cannot confirm import records", "error.forbidden_asset": "Your role cannot edit assets", "error.forbidden_members": "Only an Owner can manage members",
		...
		"validation.occurred_required": "Occurred time is required.", "validation.occurred_future": "Occurred time cannot be in the future.", "validation.event_type": "Event type must be purchase, repair, or sale.", "validation.input_invalid": "Invalid input. Check the form and try again.",
		"validation.category_icon": "Unsupported category icon.", "validation.id_invalid": "Invalid record identifier.", "validation.field_required": "A required field is empty.", "validation.field_too_long": "Input exceeds the length limit.",
