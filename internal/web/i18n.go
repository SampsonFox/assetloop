...
var messages = map[application.Locale]map[string]string{
	application.LocaleZhCN: {
		...
		"asset.voided": "已作废", "asset.show_voided": "显示已作废记录", "asset.correct": "更正", "asset.no_events": "尚无生命周期记录。", "asset.add_event": "新增生命周期记录", "asset.add_event_short": "新增记录",
	...
	application.LocaleEn: {
		...
		"asset.voided": "Voided", "asset.show_voided": "Show voided records", "asset.correct": "Correct", "asset.no_events": "No lifecycle records yet.", "asset.add_event": "Add lifecycle record", "asset.add_event_short": "Add record",
