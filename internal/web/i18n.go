...
var messages = map[application.Locale]map[string]string{
	application.LocaleZhCN: {
		...
		"assets.item": "物品", "assets.taxonomy": "类别 / 型号 / 规格", "assets.color": "颜色", "assets.channel": "渠道",
		...
		"imports.recognized_amount": "识别金额", "imports.source": "来源", "imports.review": "复核确认", "imports.view_only": "仅查看", "imports.empty": "暂无待确认导入。",
		"imports.simulate": "模拟 AI 识别结果", "imports.simulate_help": "截图识别由外部 AI Harness 完成；此表单用于验证同一待确认入口。", "imports.asset": "物品",
	...
	application.LocaleEn: {
		...
		"assets.item": "Asset", "assets.taxonomy": "Category / model / specification", "assets.color": "Color", "assets.channel": "Channel",
		...
		"imports.recognized_amount": "Recognized amount", "imports.source": "Source", "imports.review": "Review and confirm", "imports.view_only": "View only", "imports.empty": "No pending imports.",
		"imports.simulate": "Simulate AI recognition", "imports.simulate_help": "Screenshot recognition happens in the external AI Harness; this form verifies the same pending-import entry point.", "imports.asset": "Asset",
