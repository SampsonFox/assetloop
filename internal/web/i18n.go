...
var messages = map[application.Locale]map[string]string{
	application.LocaleZhCN: {
		...
		"asset.search_events": "搜索记录", "asset.search_events_placeholder": "搜索备注或汇率来源…", "asset.all_event_types": "全部事件类型", "asset.pagination": "生命周期记录分页",
	...
	application.LocaleEn: {
		...
		"asset.search_events": "Search records", "asset.search_events_placeholder": "Search notes or FX source…", "asset.all_event_types": "All event types", "asset.pagination": "Lifecycle record pagination",
