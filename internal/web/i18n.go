...
var messages = map[application.Locale]map[string]string{
	application.LocaleZhCN: {
		...
		"assets.add_type": "新增物品类型", "assets.display_name": "显示名称", "assets.display_placeholder": "我的主力手机",
	...
	application.LocaleEn: {
		...
		"assets.add_type": "Add asset type", "assets.display_name": "Display name", "assets.display_placeholder": "My primary phone",
