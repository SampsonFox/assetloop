...
var messages = map[application.Locale]map[string]string{
	application.LocaleZhCN: {
		...
		"validation.amount_required": "金额不能为空。", "validation.amount_positive": "金额必须大于 0。", "validation.amount_nonnegative": "金额不能小于 0。", "validation.amount_invalid": "金额格式无效。", "validation.currency_invalid": "货币必须是三位 ISO 代码。",
		...
		"validation.event_purchase_exists": "物品已经存在有效买入记录。", "validation.event_purchase_first": "维修或卖出前必须先记录买入。", "validation.event_after_sale": "已卖出的物品不能再添加买入、维修或卖出记录。",
	...
	application.LocaleEn: {
		...
		"validation.amount_required": "Amount is required.", "validation.amount_positive": "Amount must be greater than 0.", "validation.amount_nonnegative": "Amount must not be negative.", "validation.amount_invalid": "Invalid amount.", "validation.currency_invalid": "Currency must be a three-letter ISO code.",
		...
		"validation.event_purchase_exists": "The asset already has an active purchase record.", "validation.event_purchase_first": "The asset must be purchased before a repair or sale.", "validation.event_after_sale": "A sold asset cannot receive another purchase, repair, or sale record.",
