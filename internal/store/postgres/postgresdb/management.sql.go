...
func (q *Queries) AssetDeletionTransactions(ctx context.Context, arg AssetDeletionTransactionsParams) ([]uuid.UUID, error) {
...
func (q *Queries) AssetManagementReceipts(ctx context.Context, tenantID uuid.UUID) ([]AssetManagementReceiptsRow, error) {
