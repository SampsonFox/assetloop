...
| `internal/mcp/media.go`, `internal/integration/mcp_media_test.go` | Required-key model/asset binding and storage-free effective-binding query; real uploaded GLB tests cover receipt rollback, replay after later edits, inheritance, reference deletion guard and HTTP permissions |
